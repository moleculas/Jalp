...
import { selectDataInicioWidgets } from 'app/redux/produccion/inicioSlice';
        ...
        <div className="flex flex-col">
          ...
          <div className="flex-auto grid grid-cols-4 gap-16 mt-24">
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-indigo-50 text-indigo-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">Nuevos proyectos</Typography>
            </div>
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-green-50 text-green-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">Cerrados</Typography>
            </div>
            <Box
              sx={{
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">Resueltos</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">Por resolver</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">Re-abiertos</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">Por revisar</Typography>
            </Box>
          </div>
        </div>
      </div>
