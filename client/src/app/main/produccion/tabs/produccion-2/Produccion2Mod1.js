...
function Produccion2Mod1(props) {
                        ...
                        <div className="flex items-center w-full">
                            ...
                            <div>
                                <Typography className="text-2xl font-extrabold tracking-tight leading-tight">
                                    {`Producción tacos ${producto.producto}`}
                                </Typography>
                        ...
                        <motion.div variants={item3}>
                            <PanelProduccion1
                                columnas={[
                                    ...
                                    { nombre: 'Llorente', tipo: 'input' },
                                    { nombre: 'P.Marcos', tipo: 'input' },
                                    { nombre: 'Serfocat', tipo: 'input' },
                                    { nombre: 'Roncal', tipo: 'input' },
...
export default Produccion2Mod1;
