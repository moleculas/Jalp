    ...
    const calculoCasillas = (posicion) => {
        ...
        switch (posicion) {
            case 'pd':
                ...
                return sumatorioPd > 0 ? `${formateado(sumatorioPd)} m³` : null;
                break;
            case 'pi':
                sumatorioPi = varsEscandallo.arrayPatinIzquierdo.reduce((a, b) => a + b, 0);
                return sumatorioPi > 0 ? `${formateado(sumatorioPi)} m³` : null;
                break;
            case 'pc':
                sumatorioPc = varsEscandallo.arrayPatinCentral.reduce((a, b) => a + b, 0);
                return sumatorioPc > 0 ? `${formateado(sumatorioPc)} m³` : null;
                break;
            case 'ta':
                sumatorioPd = varsEscandallo.arrayPatinDerecho.reduce((a, b) => a + b, 0);
                sumatorioPc = varsEscandallo.arrayPatinCentral.reduce((a, b) => a + b, 0);
                sumatorioTotal = sumatorioPd + sumatorioPc + varsEscandallo.arrayPatinIzquierdo[0];
                return sumatorioTotal > 0 ? `${formateado(sumatorioTotal)} m³` : null;
                break;
            case 'pa':
            ...
            case 'pl':
                ...
                return sumatorioPl > 0 ? `${formateado(sumatorioPl)} m³` : null;
                break;
            case 'to':
                sumatorioPa = varsEscandallo.arrayPatines.reduce((a, b) => a + b, 0);
                sumatorioPd = varsEscandallo.arrayPatinDerecho.reduce((a, b) => a + b, 0);
                                                ...
                                                {escandallo.arrayPatines.map((patin, index) => {
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell sx={{ width: '20%' }} className="p-4" component="th" scope="row">
                                                                {varsEscandallo.arrayPatines[index] ? `${formateado(varsEscandallo.arrayPatines[index])} m³` : null}
                                                            </TableCell>
                                                        </TableRow>
                                                    );
                                                })}
                                                            ...
                                                            <Table>
                                                                <TableBody>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell className="p-4" component="th" scope="row">
                                                                            {varsEscandallo.arrayPatinDerecho[varsEscandallo.arrayPatinDerecho.length - 1] ? `${formateado(varsEscandallo.arrayPatinDerecho[varsEscandallo.arrayPatinDerecho.length - 1])} m³` : null}
                                                                        </TableCell>
                                                                    </TableRow>
                                                                    <TableRow
                                                                        hover
                                                                    ...
                                                                    {escandallo.arrayPatinIzquierdo.map((patin, index) => {
                                                                        return (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <TableCell className="p-4" component="th" scope="row">
                                                                                    {varsEscandallo.arrayPatinIzquierdo[index] ? `${formateado(varsEscandallo.arrayPatinIzquierdo[index])} m³` : null}
                                                                                </TableCell>
                                                                            </TableRow>
                                                                        );
                                                                    })}
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell className="p-4" component="th" scope="row">
                                                                            {varsEscandallo.arrayPatinIzquierdo[varsEscandallo.arrayPatinIzquierdo.length - 1] ? `${formateado(varsEscandallo.arrayPatinIzquierdo[varsEscandallo.arrayPatinIzquierdo.length - 1])} m³` : null}
                                                                        </TableCell>
                                                                    </TableRow>
                                                                    <TableRow
                                                                        hover
                                                                    ...
                                                                    {escandallo.arrayPatinCentral.map((patin, index) => {
                                                                        return (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <TableCell className="p-4" component="th" scope="row">
                                                                                    {varsEscandallo.arrayPatinCentral[index] ? `${formateado(varsEscandallo.arrayPatinCentral[index])} m³` : null}
                                                                                </TableCell>
                                                                            </TableRow>
                                                                        );
                                                                    })}
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell className="p-4" component="th" scope="row">
                                                                            {varsEscandallo.arrayPatinCentral[varsEscandallo.arrayPatinCentral.length - 1] ? `${formateado(varsEscandallo.arrayPatinCentral[varsEscandallo.arrayPatinCentral.length - 1])} m³` : null}
                                                                        </TableCell>
                                                                    </TableRow>
                                                                </TableBody>
                                                            </Table>
                                                ...
                                                {escandallo.arrayPalets.map((patin, index) => {
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell sx={{ width: '20%' }} className="p-4" component="th" scope="row">
                                                                {varsEscandallo.arrayPalets[index] ? `${formateado(varsEscandallo.arrayPalets[index])} m³` : null}
                                                            </TableCell>
                                                        </TableRow>
                                                    );
                                                })}
